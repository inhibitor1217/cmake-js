...
class CMake {
	...
	async getConfigureCommand() {
		...
		const outputDirectory = this.workDir.endsWith(this.config) ? this.workDir : this.buildDir
		if (environment.isWin) {
			D.push({ CMAKE_RUNTIME_OUTPUT_DIRECTORY: outputDirectory })
		} else {
			D.push({ CMAKE_LIBRARY_OUTPUT_DIRECTORY: outputDirectory })
		}
